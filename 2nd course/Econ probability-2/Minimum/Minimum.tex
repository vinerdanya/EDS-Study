...
\definition Случайная величина $X$ имеет $\chi^2$-распределение с $k$ степенями свободы, $H\sim\chi^2(m)$, если $X$ представима в виде
\begin{equation*}
    X=X_1^2+\ldots+X_m^2,
\end{equation*}
...
\definition Случайная величина $F\sim F(k,m)$ имеет распределение Фишера с параметрами $m_1$ и $m_2$ (степени свободы), если она может быть представлена в виде:
\begin{equation*}
    F = \frac{X_k/k}{X_m/m}
\end{equation*}
